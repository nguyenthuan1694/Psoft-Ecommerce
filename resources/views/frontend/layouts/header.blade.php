...
<header class="header">
    <nav class="header-menu" style="display: flex;align-items: center;justify-content: flex-end;">
        <div class="main-menu">
            ...
            <div style="position: absolute;top: 0;left: 8%;display: block;cursor: pointer;" class="aa">
                <ul class="ul-menu">
            ...
            <div style="position: absolute;top: 8px;left: 62%;display: block;cursor: pointer;" class="search">
                <form action="{{ route('search') }}" method="get">
                    <input class="form-control" type="text" name="query" placeholder="Tìm kiếm ...">
                    <button><span class="ti-search"></span></button>
                </form>
            </div>
            <div style="position: absolute;top: 0;right: 2%;display: block;cursor: pointer;">
